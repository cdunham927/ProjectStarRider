...
public class ScreenScpaeOutline : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    private class ViewSpaceNormalsTexturePass: ScriptableRenderPass 
    {
        ...
        private readonly Material normalsMaterial; // material created in the consrtuctore
        ...
        public override void Configure(CommandBuffer cmd , RenderTextureDescriptor cameraTextureDescriptor)
        {
            ...
            ConfigureTarget(normals.Identifier()); //rendder target fo rthe pass
            ConfigureClear(ClearFlag.All, normalsTextureSettings.backgroundColor); // clear rendere texture with backgrouund color
        }
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) 
        {
            ...
            CommandBuffer cmd = CommandBufferPool.Get(); // fecth new command buffer
            using (new ProfilingScope(cmd, new ProfilingSampler("SceneViewSpaceNormalsTextureCreation")))
            {
                context.ExecuteCommandBuffer(cmd);
                cmd.Clear();
                 //shader tags that should be drawn from
        ...
        //calls when the camera is finnished rendering
