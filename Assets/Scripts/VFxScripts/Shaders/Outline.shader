Shader "Unlit/OutLine"
{
    ...
    // computes screen  positio of in game objects
    ...
    //vertext shader flip image arouynd if vertex is flipped by graphics api
    ...
    float4 Frag(v2f i) : SV_Target
    {
        ...
        //color setting
        //float4 mainTex = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, i.textcoord);
